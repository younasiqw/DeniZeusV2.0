...
inline const MARGINS Margin = { 0, 0, Width, Height };

inline char lWindowName[256] = "DeniZeus Overlay";
inline HWND hWnd;

inline char tWindowName[256] = "Counter-Strike: Global Offensive";
inline HWND tWnd;
inline RECT tSize;

inline MSG Message;
inline bool Debug_Border;
