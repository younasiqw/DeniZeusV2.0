...
inline int DrawString(char* String, int x, int y, int r, int g, int b, ID3DXFont* ifont)
{
	RECT ShadowPos;
	ShadowPos.left = x + 1;
	ShadowPos.top = y + 1;
...
inline void FillRGB(float x, float y, float w, float h, int r, int g, int b, int a)
{
	D3DXVECTOR2 vLine[2];
...
inline void GradientFunc(int x, int y, int w, int h, int r, int g, int b, int a)
{
...
inline void DrawLine(float x, float y, float xx, float yy, float width, int r, int g, int b, int a)
{
	D3DXVECTOR2 dLine[2];
...
inline void DrawBox(float x, float y, float width, float height, float px, int r, int g, int b, int a)
{
...
inline void DrawGUIBox(float x, float y, float w, float h, int r, int g, int b, int a, int rr, int gg, int bb, int aa)
{
	DrawBox(x, y, w, h, 1, r, g, b, a);
	FillRGB(x, y, w, h, rr, gg, bb, a);
}
inline void DrawHealthBar(float x, float y, float w, float h, int r, int g, int b)
{
	FillRGB(x, y, w, h, r, g, b, 255);
}
inline void DrawHealthBarBack(float x, float y, float w, float h)
{
	FillRGB(x, y, w, h, 1, 1, 1, 255);
}
inline void DrawCenterLine(float x, float y, int width, int r, int g, int b)
{
...
inline void DrawBoxWithRect(RECT rect, float width, int r, int g, int b, int a) {
	DrawLine(rect.left, rect.top, rect.right, rect.top, width, r, g, b, a);
	DrawLine(rect.left, rect.top, rect.left, rect.bottom, width, r, g, b, a);
	DrawLine(rect.right, rect.top, rect.right, rect.bottom, width, r, g, b, a);
	DrawLine(rect.left, rect.bottom, rect.right, rect.bottom, width, r, g, b, a);
}
